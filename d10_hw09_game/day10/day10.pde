...
void draw() {
  ...
  if(score >= 10){
    level = 1;
     //now, as the score increases, 
   maxAliens = score + 2;  //we'll add more aliens!
   newAlienTiming = 50 - score*2;  //and the faster they spawn!
   alienSpeed = random(score/4 +0.5, score/4 +2);  //and the faster they go!
  
  }
  if(score >= 10){
    level = 2;
     //now, as the score increases, 
   maxAliens = score + 5;  //we'll add more aliens!
   newAlienTiming = 50 - score*3;  //and the faster they spawn!
   alienSpeed = random(score/4 +1.5, score/4 +3);  //and the faster they go!
